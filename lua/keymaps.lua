...
-- Oil
keymap.set("n", "<leader>fv", function() require("oil").open() end, { desc = "Open directory" })
...
-- When highlight pasting keep the yank buffer
...
local keymaps_to_disable = { "grn", "gra", "gri", "grr" }
